...
public class Lab114 {
    public static void main(String[] args) {
        ...
        if (voting_age >= 18){
            System.out.println("You sre allowed to vote!");
        }else {
        ...
        greet_with_your_name("Ketan");
        greet_with_your_name("Deolikar");

        greet_with_first_name_last_name("Ketan", "Deolikar");
    ...
    static void greet(){
        System.out.println("Hi, How are you bruhhh");
    }
